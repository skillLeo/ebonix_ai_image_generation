...
*/
// Load representation defaults
require_once QA_INCLUDE_DIR . 'king-db/king-db-representation-defaults.php';
...
*/
	...
	function script_options(&$qa_content) {
		...
		$qa_content['script_var']['max_vid_upload'] = (int) qa_opt('video_max_upload');
					$qa_content['script_rel'][] = 'king-content/js/dropzone.min.js';
			$qa_content['script_rel'][] = 'king-content/js/angular/angular.min.js';
			$qa_content['script_rel'][] = 'king-content/js/angular/sortable.min.js';
			$qa_content['script_rel'][] = 'king-content/js/angular/jquery-ui.min.js';
			$qa_content['script_rel'][] = 'king-content/js/angular/app.js';
			$qa_content['script_rel'][] = 'king-content/js/angular/appi.js';
			$qa_content['script_rel'][] = 'king-content/js/tinymce/tinymce.min.js';
	...
	<div class="king-form-tall-error" id="ai-error" style="display: none;"></div>
		<div class=" kingai-aski">
			...
			<div class="kingai-buttons">
				<button type="button" id="ai-ask" class="ai-submit" onclick="return aiask(this);" >
