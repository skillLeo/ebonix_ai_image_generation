...
/*
	...
	File: king-include/king-app-emails.php
...
*/
	...
	//	@error_log(print_r($params, true));
		...
		require_once QA_INCLUDE_DIR.'king-vendor/PHPMailer/PHPMailerAutoload.php';
		...
		if(!$send_status){
			@error_log('PHP King-Media email send error: '.$mailer->ErrorInfo);
		}
		return $send_status;
	}
