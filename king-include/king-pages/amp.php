...
<header class="amp-king-header">
	<div class="amp-king-logo">
			<a href="'.qa_opt('site_url').'" class="amp-king-logo-img">
				<amp-img src="'.$logo.'" width="200" height="60" layout="responsive"></amp-img>
			</a>
	</div>
...
<div class="amp-share">
		...
		<div class="amp-meta">
			<a href="' . qa_path_html('user/'.qa_userid_to_handle($post['userid'])) . '">
				<amp-img src="' . qa_path_html('image', array('qa_blobid' => $useraccount['avatarblobid'], 'qa_size' => 40), null, QA_URL_FORMAT_PARAMS) . '" width="40" height="40"></amp-img>
			</a>
