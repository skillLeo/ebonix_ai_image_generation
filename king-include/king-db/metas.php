...
/*
	...
	File: king-include/king-db-metas.php
...
/*
	Set the metadata for user $userid with $key to $value. Keys beginning qa_ are reserved for the KINGMEDIA core.
*/
	{
...
/*
	Set the metadata for post $postid with $key to $value. Keys beginning qa_ are reserved for the KINGMEDIA core.
*/
	{
...
/*
	Set the metadata for category $categoryid with $key to $value. Keys beginning qa_ are reserved for the KINGMEDIA core.
*/
	{
...
/*
	Set the metadata for tag $tag with $key to $value. Keys beginning qa_ are reserved for the KINGMEDIA core.
*/
	{
